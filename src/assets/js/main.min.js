...
(function () {
    ...
    angular.module('controlpanel', ['ngRoute', 'ui.router', 'ui.router.state.events', 'ngDialog', 'LocalStorageModule', 'controlpanel.core', 'controlpanel.home', 'controlpanel.login', 'controlpanel.user', 'controlpanel.item', 'controlpanel.error']);
})();
'use strict';
...
(function () {
    ...
    angular.module('controlpanel.error').service('accessDeniedService', accessDeniedService);
...
(function () {
    ...
    angular.module('controlpanel.error').service('serverUndefinedService', serverUndefinedService);

    serverUndefinedService.$inject = [];

    function serverUndefinedService() {}
})();
'use strict';
