...
!function(){"use strict";function t(t){function n(n,e){return t.get(n,{params:e}).then(u)["catch"](a)}function e(n,e){return t.post(n,e).then(u)["catch"](a)}function r(n,e){return t["delete"](n,{params:e}).then(u)["catch"](a)}function c(n,e){return t(n,e).then(u)["catch"](a)}function u(t,n,e,r){return t.data}function a(t){return t.status===-1?"server undefined":t.data}var i=this;i.get=n,i.post=e,i["delete"]=r,i.put=c}angular.module("controlpanel.core").service("HTTPService",t),t.$inject=["$http"]}();
...
!function(){"use strict";function e(e,r,t,n,U){function a(n){var U=(r.URL+t.GET_USER).format(n);return e.get(U)}function o(n){var U=r.URL+t.POST_USER;return e.post(U,n)}function u(n){var U=(r.URL+t.PUT_USER).format(n._id);return e.put(U,n)}function i(n){var U=(r.URL+t.DELETE_USER).format(n);return e["delete"](U)}function c(){var n=r.URL+t.GET_LIST_USER;return e.get(n)}var s=this;s.getUser=a,s.saveUser=o,s.updateUser=u,s.deleteUser=i,s.getListUser=c}angular.module("controlpanel.core").service("CoreUserService",e),e.$inject=["HTTPService","API","USER","StorageData","$q"]}();